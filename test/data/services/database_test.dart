...
void main() {
  ...
  test('moveReceipt', () async {
    final targetFolderId = Utility.generateUid();
    final targetFolder = Folder(id: targetFolderId, name: 'targetFolder', lastModified: Utility.getCurrentTime(), parentId: rootFolderId);
    ...
    test('getRecentReceipts', () async {
      ...
      for (int i = 0; i < 10; i++) {
        final receipt = Receipt(
          ...
          dateCreated: i < 8 ? Utility.getCurrentTime() : 1000, // set old timestamp for last two receipts
          lastModified: i < 8 ? Utility.getCurrentTime() : 1000, // set old timestamp for last two receipts
          storageSize: 100,
    ...
    test('getReceiptByName', () async {
      ...
      final retrievedReceipts = await dbService.getReceiptByName(receipt.name);
